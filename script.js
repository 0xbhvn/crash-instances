var config = {
    ...
    baseBet: { label: 'Starting Bet:', value: currency.amount / 2400, type: 'number' },
...
function main() {
    ...
    game.onBet = function () {
        ...
        game.bet(currentBet, currentPayout).then(function (payout) {
            if (payout > 1) {
                if (!gameStatus) { counterReset(true) }
